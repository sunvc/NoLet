...
struct ChangeKeyCenterView: View {
    ...
    var pageTitle: String.LocalizationValue {
        keyName.isEmpty ? "注册KEY" : "恢复KEY"
    }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            HStack {
                Label {
                    Text(String(localized: pageTitle))
    ...
    private func recoverButton() -> some View {
        VStack {
            AnimatedButton(
                ...
                await handle.loading(title: "检查参数...", background: .cyan)
                ...
                await handle.loading(title: "恢复中...", background: .cyan)
    ...
    private func registerButton() -> some View {
        VStack {
            AnimatedButton(
                ...
                await handle.loading(title: "注册中...", background: .cyan)
