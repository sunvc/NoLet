...
class NearbyNoLetManager: NSObject, ObservableObject {
    ...
    private var incomingMessageId: [String: UUID] = [:] // key: peer.displayName + "|" + resourceName
    ...
    func sendGroupImage(_ imageData: Data) {
        ...
        let tempURL = FileManager.default.temporaryDirectory.appendingPathComponent("nolet-image-\(UUID().uuidString).jpg")
