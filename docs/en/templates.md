...
Aero messages use the `style` field to switch between different card templates. This document lists all available fields organized by template.
...
Message(
    group: "Docs",
    title: "Aero User Guide",
    body: """
    # Quick Start
    ## Installation
    Search for **Aero** in the App Store and download.
    ## Configuration
    1. Open the App
