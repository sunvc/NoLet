...
Sender <font color='red'> →Server①</font> → Apple APNS Server → Your Device → <font color='red'>BravoPapa APP②</font>.
...
* The BravoPapa App itself is not secure, and the version uploaded to the App Store has been modified.
...
To ensure the App is secure and has not been modified by anyone (including the author), BravoPapa is built by Apple Xcode Cloud and then uploaded to the App Store.
